...
// Note: 'using namespace ImGui' is intentionally NOT here to avoid namespace pollution.
// It is placed in imguiedited.cpp instead.
...
// All ImGui widget declarations (CustomChild, EndCustomChild, KeyBind, TabHeader)
// are already declared in imgui.h. Do not redeclare them here.