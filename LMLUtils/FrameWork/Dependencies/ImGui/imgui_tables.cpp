...
void ImGui::TableMergeDrawChannels(ImGuiTable* table)
{
    ...
    if (g.IO.KeyShift)
        for (int merge_group_n = 0; merge_group_n < IM_ARRAYSIZE(merge_groups); merge_group_n++)
        {
            ...
            GetForegroundDrawList()->AddRectFilled(text_pos, text_pos + text_size, IM_COL32(0, 255, 255, 255));
...
void ImGui::TableHeader(const char* label)
{
    ...
    //GetForegroundDrawList()->AddRect(cell_r.Min, cell_r.Max, IM_COL32(255, 255, 255, 255)); // [DEBUG]
    //GetForegroundDrawList()->AddRect(bb.Min, bb.Max, IM_COL32(255, 255, 255, 255)); // [DEBUG]
