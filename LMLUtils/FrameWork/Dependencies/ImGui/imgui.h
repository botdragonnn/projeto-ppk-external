...
namespace ImGui
{
    ...
    IMGUI_API bool          WeaponButtonHeld(ImTextureID Icon, const char* label, ImGuiButtonFlags flags);
    IMGUI_API bool          CfgButton(const char* Label, std::function<void()> Components);
