...
//#endif
    ...
    IMGUI_API void          DebugDrawCursorPos(ImU32 col = IM_COL32(255, 255, 255, 255));
    IMGUI_API void          DebugDrawLineExtents(ImU32 col = IM_COL32(255, 255, 255, 255));
    IMGUI_API void          DebugDrawItemRect(ImU32 col = IM_COL32(255, 255, 255, 255));
