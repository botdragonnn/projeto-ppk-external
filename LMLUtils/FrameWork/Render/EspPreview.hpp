	...
	public:
        ...
        void Draw()
        {
            ...
            if (boxOpts.HeadCircle)
            {
                ...
                ImGui::GetWindowDrawList()->AddCircle(headCenter, headR, headCol, 24, 1.5f);
            }
            ...
            if (boxOpts.Skeleton)
            {
                ...
                DL->AddLine(neck, lShld, skelCol, 1.5f);
                DL->AddLine(neck, rShld, skelCol, 1.5f);
                DL->AddLine(lShld, lHand, skelCol, 1.5f);
                DL->AddLine(rShld, rHand, skelCol, 1.5f);
                DL->AddLine(neck, pelvis, skelCol, 1.5f);
                DL->AddLine(pelvis, lFoot, skelCol, 1.5f);
                DL->AddLine(pelvis, rFoot, skelCol, 1.5f);
            }
            ...
            if (boxOpts.SnapLines)
            {
                ...
                ImGui::GetWindowDrawList()->AddLine(bottomCenter, bottomEnd, snapCol, 1.5f);
            }
